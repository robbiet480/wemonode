...
function WemoNode() {
    ...
    this._socket_messageHandler = function(msg, rinfo) {
        ...
        if (!found) {
            ...
            //obj.USN = objectUSN;
            var splitUSN = objectUSN.substr(5).replace(/::.*$/,"").replace(/_/g,".").split('-');
    ...
    this._updateBinaryStates = function () {
        ...
        this.wemoObjects.forEach(function (singleObject) {
            ...
            this.sendCommand("all_getbinarystate", singleObject, null, function (err, response) {
                err = err || false;
                if (err) {
                    return;
                }
